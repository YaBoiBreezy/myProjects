...
public class TrieMapNode{
  ...
  public HashMap<Character, TrieMapNode> getChildren(){ return children; }

  public void setChildren(HashMap<Character, TrieMapNode> newChildren){ children = newChildren; }
}
