...
let students = [
	...
	console.log(students.filter(student => student.egrade >=80).map(student => student.fname + " " + student.lname));
	console.log(students.reduce((gradeTotal, student) => gradeTotal + (student.agrade*0.4)+(student.tgrade*0.1)+(student.egrade*0.5), 0)/students.length);